...
<!-- Mirrored from themes.pixelstrap.com/chitchat/pages/messenger.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 07 Jun 2023 10:25:49 GMT -->
<head>
    <title>Hengel</title>
    ...
    <!-- magnific-popup css -->
    <link href="{{url('public')}}/assets/libs/magnific-popup/magnific-popup.css" rel="stylesheet" type="text/css" />
    ...
    <div class="side-menu flex-lg-column me-lg-1 ms-lg-0">
        ...
        <div class="navbar-brand-box">
            <a href="index.html" class="logo logo-dark">
                <span class="logo-sm">
                    <img src="{{url('public')}}/assets/images/logo.svg" alt="" height="30">
                </span>
            </a>
            ...
            <ul class="nav nav-pills side-menu-nav justify-content-center" role="tablist">
                ...
                <li class="nav-item dropdown profile-user-dropdown d-inline-block d-lg-none">
                    <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <img src="{{url('public')}}/assets/images/users/avatar-1.jpg" alt="" class="profile-user rounded-circle">
                    </a>
            ...
            <div class="tab-pane" id="pills-user" role="tabpanel" aria-labelledby="pills-user-tab">
                ...
                <div>
                    ...
                    <div class="text-center p-4 border-bottom">
                        <div class="mb-4">
                            <img src="{{url('public')}}/assets/images/users/avatar-1.jpg" class="rounded-circle avatar-lg img-thumbnail" alt="">
                        </div>
                    ...
                    <div class="">
                        ...
                        <div class="chat-message-list px-2" data-simplebar>
                            ...
                            <ul class="list-unstyled chat-list chat-user-list">
                                      ...
                                      @foreach ($uchat as $item)
                                      <li>
                                    <a href="#">
                                      @php
                                          $userdata = DB::table('user')->where('id', $item->receiver)->first();
                                      @endphp
                                  
                                      <div class="d-flex">                            
                                          <div class="chat-user-img online align-self-center me-3 ms-0">
                                              <img src="{{ url('storage/app/public/homebanner')}}/{{ $userdata->profile }}" class="rounded-circle avatar-xs" alt="">
                                              <span class="user-status"></span>
                                          </div>
                                  
                                          <div class="flex-grow-1 overflow-hidden">
                                              <h5 class="text-truncate font-size-15 mb-1">
                                                  <h5 style="text-transform: capitalize;">{{ $userdata->name }}</h5>
                                              </h5>
    ...
    <div class="user-chat w-100 overflow-hidden">
        <div class="d-lg-flex">
                    ...
                    <div class="row align-items-center">
                        <div class="col-sm-4 col-8">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="me-3 ms-0">
                                    <img src="{{url('public')}}/assets/images/users/avatar-4.jpg" class="rounded-circle avatar-xs" alt="">
                                </div>
                                <div class="flex-grow-1 overflow-hidden">
                ...
                <div class="chat-conversation p-3 p-lg-4" data-simplebar="init">
                    <ul class="list-unstyled mb-0">
                        ...
                        <li class="right">
                            <div class="conversation-list">
                                <div class="chat-avatar">
                                    <img src="{{url('public')}}/assets/images/users/avatar-1.jpg" alt="">
                                </div>
                                        ...
                                        <div class="ctext-wrap-content">
                                            <ul class="list-inline message-img  mb-0">
                                                <li class="list-inline-item message-img-list me-2 ms-0">
                                                    <div>
                                                        <a class="popup-img d-inline-block m-1" href="{{url('public')}}/assets/images/small/img-1.jpg" title="Project 1">
                                                            <img src="{{url('public')}}/assets/images/small/img-1.jpg" alt="" class="rounded border">
                                                        </a>
                                                    </div>
                                                    <div class="message-img-link">
                                                        <ul class="list-inline mb-0">
                                                            <li class="list-inline-item">
                                                                <a download="img-1.jpg" href="{{url('public')}}/assets/images/small/img-1.jpg" class="fw-medium">
                                                                    <i class="ri-download-2-line"></i>
                                                                </a>
                                                            </li>
                                                            <li class="list-inline-item dropdown">
                                                ...
                                                <li class="list-inline-item message-img-list">
                                                    <div>
                                                        <a class="popup-img d-inline-block m-1" href="{{url('public')}}/assets/images/small/img-2.jpg" title="Project 2">
                                                            <img src="{{url('public')}}/assets/images/small/img-2.jpg" alt="" class="rounded border">
                                                        </a>
                                                    </div>
                                                    <div class="message-img-link">
                                                        <ul class="list-inline mb-0">
                                                            <li class="list-inline-item">
                                                                <a download="img-2.jpg" href="{{url('public')}}/assets/images/small/img-2.jpg" class="fw-medium">
                                                                    <i class="ri-download-2-line"></i>
                                                                </a>                                                                        
                                                            </li>
                                                            <li class="list-inline-item dropdown">
                                                ...
                                                <div class="d-flex flex-wrap align-items-center attached-file">
                                                    ...
                                                    <div class="ms-4 me-0">
                                                        <div class="d-flex gap-2 font-size-20 d-flex align-items-start">
                                                            <div>
                                                                <a download="admin_v1.0.zip" href="{{url('public')}}/assets/images/small/admin_v1.0.zip" class="fw-medium">
                                                                    <i class="ri-download-2-line"></i>
                                                                </a> 
                                                            </div>
                                                            <div class="dropdown">
                ...
                <div class="chat-input-section p-3 p-lg-4 border-top mb-0">
                    <div class="row g-0">
                        <div class="col">
                            ...
                            <input name="message" id="message" class="form-control form-control-lg bg-light border-light" placeholder="Enter Message...">
                        </div>
                        <div class="col-auto">
                            <div class="chat-input-links ms-md-2 me-md-0">
                                <ul class="list-inline mb-0">
                                    ...
                                    <li class="list-inline-item">
                                        <button type="button" onclick="sendmessage()" class="btn btn-primary font-size-16 btn-lg chat-send waves-effect waves-light">
            ...
            <div class="user-profile-sidebar">
                ...
                <div class="text-center p-4 border-bottom">
                    <div class="mb-4">
                        <img src="{{url('public')}}/assets/images/users/avatar-4.jpg" class="rounded-circle avatar-lg img-thumbnail" alt="">
                    </div>
                ...
                <div class="modal-body">
                    <div class="text-center p-4">
                        <div class="avatar-lg mx-auto mb-4">
                            <img src="{{url('public')}}/assets/images/users/avatar-4.jpg" alt="" class="img-thumbnail rounded-circle">
                        </div>
...
<!-- Magnific Popup-->
<script src="{{url('public')}}/assets/libs/magnific-popup/jquery.magnific-popup.min.js"></script>

<!-- owl.carousel js -->
<script src="{{url('public')}}/assets/libs/owl.carousel/owl.carousel.min.js"></script>

<!-- page init -->
<script src="{{url('public')}}/assets/js/pages/index.init.js"></script>
